...
jQuery(document).ready(function ($) {
    ...
    $('#close_activebar').click(function() {
        const masthead = document.getElementById('masthead');
        masthead.classList.remove('show-activebar');
        document.cookie = "active_bar=false;path=/";
    });
});
...
function checkCookie() {
    let activebar_cookie = getCookie("active_bar");
    const masthead = document.getElementById('masthead');

    if (activebar_cookie == '') {
        masthead.classList.add('show-activebar');
    }
}
/******/ })()
;